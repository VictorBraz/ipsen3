...
{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:"Zondag Maandag Dinsdag Woensdag Donderdag Vrijdag Zaterdag".split(" "),ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"],FIRSTDAYOFWEEK:6,MONTH:"Januari Februari Maart April Mei Juni Juli Augustus September Oktober November December".split(" "),SHORTDAY:"Zo Ma Di Wo Do Vr Za".split(" "),SHORTMONTH:"jan feb mrt apr mei jun jul aug sep okt nov dec".split(" "),STANDALONEMONTH:"Januari Februari Maart April Mei Juni Juli Augustus September Oktober November December".split(" "),
WEEKENDRANGE:[5,6],fullDate:"EEEE, d MMMM y",longDate:"d MMMM y",medium:"d MMM, y h:mm:ss a",mediumDate:"MMM d, y",mediumTime:"h:mm:ss a","short":"M/d/yy h:mm a",shortDate:"M/d/yy",shortTime:"h:mm a"},NUMBER_FORMATS:{CURRENCY_SYM:"$",DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-\u00a4",negSuf:"",posPre:"\u00a4",posSuf:""}]},id:"en-us",localeID:"en_US",pluralCat:function(a,
